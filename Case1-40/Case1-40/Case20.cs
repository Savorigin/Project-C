...
namespace Case1_40
{
    ...
    class Case20
    {
        ...
        static int EnterDay(int month_for_day)
        {
            ...
            while (true)
            {
                try
                {
                    ...
                    switch (month_for_day)
                    {
                        ...
                        case 1: case 3: case 5: case 7: case 8: case 10: case 12: count_of_days = 31; break;
                        case 4: case 6: case 9: case 11: count_of_days = 30; break;
        ...
        static void ChouseAndWriteHoroscope(int month, int day)
        {
            switch (month)
            {
                case 1:
        ...
        public static void Task()
        {
            ...
            int day = EnterDay(month);
            ChouseAndWriteHoroscope(month, day);
            Console.ReadLine();
        }
    }
}
